...
function OrphanagesMap() {
  ...
  function callPeer(id: any) {
    if(id!=='' && users[id] && id!==yourID){
      ...
      .catch(()=>{
        toast.error('Por favor, verifique se possui (Câmera, Microfone). Certifique-se de dar as devidas permissões de acesso para o navegador.')
        
      })
    } else {
      toast.error('Opa, usuário não encontrado, tem certeza que digitou corretamente?')
